...
class CockroachMemoryStore:
    ...
    def __init__(self):
        ...
        if not CockroachMemoryStore._schema_initialized:
            self._init_schema()
            CockroachMemoryStore._schema_initialized = True

    # ------------------------------------------------------------------
    # Connection management & Schema Auto-Provisioning
    # ------------------------------------------------------------------
    ...
    def _init_schema(self):
        """Auto-create tables and indexes if they do not already exist."""
        try:
            cur = self._cursor()
            # 1. Vector extension
            try:
            ...
            CREATE TABLE IF NOT EXISTS incidents (
                ...
                description TEXT,
                severity VARCHAR(50) DEFAULT 'P3',
            ...
            print(f"[WARNING] Auto-schema init warning: {e}")
